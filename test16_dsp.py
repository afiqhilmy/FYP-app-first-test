...
def page_home():
    ...
    By combining geospatial intelligence with predictive analytics, this project contributes to smarter and more efficient EV infrastructure development.</span>""", unsafe_allow_html=True)
